...
# All Schools (1): Number of pupils with SEN support, based on where the pupil attends school
...
Dimensions = [
            ...
            HDimConst('Education provider','all-schools'),
...
new_table['Special support type'] = 'sen-support'
new_table['Age']  = 'All'
new_table['Sex']  = 'All'
