...
ethnicity = cell.fill(DOWN).is_not_blank().is_not_whitespace() | cell.shift(1,0).fill(DOWN).is_not_blank().is_not_whitespace()
...
Dimensions1 = [
            ...
            HDim(ethnicity,'Special support type', DIRECTLY,LEFT),
            HDimConst('Sex','all'),
            HDimConst('Age','all')            
]
...
new_table['Special support type'] = new_table['Special support type'].str.rstrip('78() ')
new_table['Special support type'] = 'statements-or-ehc-plans-support-by-ethnic-group-' + new_table['Special support type']
