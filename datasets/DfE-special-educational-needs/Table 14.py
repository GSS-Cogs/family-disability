...
# State-funded primary, secondary and special schools (1,2): number of pupils with special educational needs, based on where the pupil attends school
...
cell.assert_one()
school = cell.shift(0,-1).fill(RIGHT).is_not_blank().is_not_whitespace()    
...
Dimensions = [
            ...
            HDim(school,'Education provider',CLOSEST,LEFT),
...
new_table['Special support type'] = 'local-area'
new_table['Age']  = 'All'
new_table['Sex']  = 'All'
