...
# State-funded secondary schools (1,2): Number and percentage of pupils with special educational needs by primary type of need (3)
...
Dimensions = [
            ...
            HDimConst('Education provider','Local Authority State funded Secondary Schools'),
