...
# Table 32:  Median earnings by responsibility level, government department and gender (All Employees)
...
dimensions = [
    ...
    HDim(responsibility_level, 'Department', CLOSEST, LEFT), 
    HDim(department, 'Responsibility Level', DIRECTLY, LEFT),
]
