...
Dimensions = [
            ...
            HDimConst('Statements of SEN or EHC Plan Description', 'Placement of children and young people for whom EHC plans by local authority receiving provisions')
]  
...
def user_perc(x,y):
    ...
    if ((str(x) ==  'Apprenticeships ') | (str(x) ==  'Traineeships') | (str(x) ==  'Supported internships')) : 
        ...
        return 'Placement of children and young people with EHC plans by local authority undertaking'
    else:
        return y
