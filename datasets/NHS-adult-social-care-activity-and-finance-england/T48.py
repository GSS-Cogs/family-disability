...
tab = next(t for t in scraper.distributions[0].as_databaker() if t.name == 'T48')
...
Dimensions = [
            ...
            HDimConst('Adult Social Care activity','Unplanned and planned reviews during the year of clients that have been accessing long term support for more than 12 months at the end of the year'),
...
new_table['Adult Social Care group'] = ''
