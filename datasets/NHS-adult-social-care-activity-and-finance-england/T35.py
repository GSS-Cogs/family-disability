...
tab = next(t for t in scraper.distributions[0].as_databaker() if t.name == 'T35')
...
new_table['Adult Social Care activity'] = new_table['Adult Social Care activity'] + ' during the year'
