...
tab = next(t for t in scraper.distributions[0].as_databaker() if t.name == 'T53')
...
new_table['Adult Social Care activity'] = 'Weekly costs for clients accessing residential long term support-' + new_table['Adult Social Care activity']
