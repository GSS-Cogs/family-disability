...
tab = next(t for t in scraper.distributions[0].as_databaker() if t.name == 'T52')
...
new_table['Adult Social Care activity'] = 'Weekly costs for clients aged 65 and over accessing residential or nursing long term support-' + new_table['Adult Social Care activity']
