...
tab = next(t for t in scraper.distributions[0].as_databaker() if t.name == 'T39')
...
new_table['Adult Social Care activity'] = new_table['Adult Social Care activity'] + ' at the end of the year'
